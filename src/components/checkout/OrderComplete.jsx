  ...
  return (
    <div className="container h-[100svh] !relative">
      <div className="text-center absolute w-[90%] top-[30%] left-[50%] -translate-x-[50%]">
        <strong className="font-semibold text-base md:text-lg text-gray-800">Your order has been confirmed.</strong>
        ...
        <Link to={'/mypage'} className="block text-sm text-gray-500 underline underline-offset-2 mt-8">
          view my orders
        </Link>
      </div>
    </div>
