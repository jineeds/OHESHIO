...
const SideMenuBar = ({ setIsChatOpen }) => {
    ...
    return (
        <>
            {/* 히스토리 패널 */}
            {isHistoryOpen && (
                <div className='fixed right-[105px] top-[543px] bg-primary-200 rounded-lg shadow-lg z-50 w-[776px] h-[317px] transition-all duration-300'>
                    <div className='flex h-full'>
                        {/* 왼쪽 섹션 - 최근 본 카테고리 */}
                        <div className='w-1/2 p-6 border-r border-gray-200'>
                            <h2 className='font-korean text-base font-bold text-gray-800 mb-6'>최근 본 카테고리</h2>
                            <p className=' font-korean text-gray-600'>최근 본 카테고리가 없습니다.</p>
                        </div>
