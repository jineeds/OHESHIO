  ...
  return (
    <>
      ...
      >
        ...
        >
          <svg xmlns='http://www.w3.org/2000/svg' className='h-6 w-6' fill='none' viewBox='0 0 24 24' stroke='#375785'>
        ...
        {isHistoryOpen && (
          <div className='fixed right-20 bottom-0 bg-primary-200 rounded-lg shadow-lg z-50 w-[776px] h-[317px] transition-all duration-300'>
            <div className='flex h-full'>
                    ...
                    <div className='swiper-wrapper'>
                      ...
                      {[
                        ...
                        <div key={index} className='swiper-slide'>
                          ...
                          >
                            <img src={imagePath} alt={`안경 ${index + 1}`} className='w-full h-full object-cover' />
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              <div className='w-1/2 p-6'>
                ...
                {recentlyViewed.length > 0 ? (
                  ...
                  <>
                    <p className='text-gray-400'>Please log in to view your recently viewed items.</p>
                    <Link to={'/login'} className='block text-center text-gray-500 mt-5 hover:text-gray-600'>
                      Login
                    </Link>
                  </>
                )}
            ...
            {/* 닫기 버튼 */}
            <button onClick={toggleHistory} className='absolute top-2 right-2 text-gray-500 hover:text-gray-700'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-6 w-6'
                fill='none'
